...
public class PersonMapper {
    ...
    public static PersonDTOv2 mapToPersonDTOv2(Person person) {
    ...
    public static Person mapToPerson(PersonDTOv2 personDTOv2) {
    ...
    public static List<PersonDTO> mapToListPersonDTO(List<Person> personList) {
